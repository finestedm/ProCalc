...
export const SummarySection: React.FC<Props> = ({ appState, onUpdateState, data, readOnly }) => {
    ...
    return (
        <div className="animate-slideUp">
            ...
            <div className="bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 rounded-xl overflow-hidden shadow-sm border border-zinc-200 dark:border-zinc-800 grid grid-cols-1 lg:grid-cols-4">
                    ...
                    <div className="border-t border-zinc-100 dark:border-zinc-800 p-4 bg-zinc-50/50 dark:bg-zinc-900/30 flex-1 flex items-center">
                        <div className="flex items-center gap-6 w-full">
                            ...
                            <div className="flex gap-4 min-w-[300px] flex-1">
                                {/* Advance 1 */}
                                <div className="flex-1 bg-white dark:bg-zinc-800 p-2 rounded border border-zinc-200 dark:border-zinc-700 shadow-sm">
                                ...
                                {/* Final Payment */}
                                <div className="flex-1 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 p-2 rounded relative shadow-sm">
                                    <div className="flex justify-between items-center text-[10px] text-zinc-400 mb-1">
                                        <span>Końcowa</span>
                                        <div className="flex items-center">
                                            <input
                ...
                <div className="lg:col-span-1 border-t lg:border-t-0 lg:border-l border-zinc-200 dark:border-zinc-800 relative bg-zinc-50 dark:bg-zinc-900/50">
                    ...
                    <div className="flex flex-col justify-center h-full p-6 z-10 relative">
                        ...
                        <div className="mt-4 w-full space-y-2">
                            {/* WARNING BLOCKS */}
                            {isCriticalMargin && (
                                <div className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 p-2 rounded flex items-center gap-2 text-red-700 dark:text-red-400 animate-pulse">
                                    <AlertOctagon size={16} className="shrink-0" />
                                    <span className="text-[10px] font-bold uppercase leading-tight">Poziom Krytyczny!<br />Marża poniżej 6%</span>
                                </div>
                            )}
                            {isWarningMargin && (
                                <div className="bg-orange-50 dark:bg-orange-900/30 border border-orange-200 dark:border-orange-800 p-2 rounded flex items-center gap-2 text-orange-700 dark:text-orange-400">
