...
export const SummarySection: React.FC<Props> = ({ appState, onUpdateState, data }) => {
  ...
  return (
    <div className={`bg-white dark:bg-zinc-800 p-6 rounded-2xl shadow-lg shadow-zinc-200/50 dark:shadow-black/30 border-t-4 mt-8 transition-colors ${appState.manualPrice !== null ? 'border-zinc-800 dark:border-zinc-500' : 'border-yellow-500'}`}>
      <div className="flex items-center justify-between mb-6">
        ...
        {appState.manualPrice !== null && (
            <button 
                ...
                className="text-xs flex items-center gap-1 text-zinc-600 dark:text-zinc-400 bg-zinc-100 dark:bg-zinc-700 px-3 py-1.5 rounded-full hover:bg-zinc-200 dark:hover:bg-zinc-600 border border-zinc-200 dark:border-zinc-600 transition-colors"
            >
      ...
      <div className="border-t border-zinc-100 dark:border-zinc-700 pt-6 mb-6">
