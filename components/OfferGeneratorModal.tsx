...
export const OfferGeneratorModal: React.FC<Props> = ({ data, appState, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-fadeIn">
        <div className="bg-zinc-100 dark:bg-zinc-900 rounded-lg shadow-2xl w-full max-w-6xl h-[90vh] flex flex-col overflow-hidden animate-scaleIn">
            ...
            {/* PREVIEW AREA (A4) */}
            <div className="flex-1 overflow-y-auto p-8 bg-zinc-200 dark:bg-black/50 flex justify-center custom-scrollbar print:p-0 print:bg-white print:overflow-visible">
                <div className="bg-white text-zinc-900 w-[210mm] min-h-[297mm] shadow-lg p-[20mm] flex flex-col relative text-[12px] leading-snug print:shadow-none print:w-full print:min-h-0 print:p-0">
