...
export const InstallationSection: React.FC<Props> = ({
    ...
    const renderStage = (stage: InstallationStage, index: number) => {
        ...
        return (
            <div
                key={stage.id}
                className={`bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl mb-4 relative shadow-sm transition-all overflow-hidden
                ...
                <div className="flex justify-between items-center p-4 bg-zinc-50/50 dark:bg-zinc-900 border-b border-zinc-100 dark:border-zinc-800">
                    <div className="flex items-center gap-3 w-full max-w-md">
                        <button
                            ...
                            className="bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 p-1.5 rounded transition-colors text-zinc-500 dark:text-zinc-300"
                        >
                    ...
                    <div className="overflow-hidden">
                        <div className="p-4">
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                <div className="bg-zinc-50 dark:bg-zinc-900/30 p-3 border border-zinc-100 dark:border-zinc-800 rounded">
                                ...
                                <div className="lg:col-span-2 space-y-4">
                                    ...
                                    {(stage.calcMethod === 'TIME' || stage.calcMethod === 'BOTH') && (
                                        <div className="grid grid-cols-4 gap-3 animate-fadeIn bg-zinc-50/50 dark:bg-zinc-900/50 border border-zinc-100 dark:border-zinc-800 p-3 rounded">
                                        ...
                                        <div key={item.id} className={`flex gap-2 items-center mb-1.5 relative ${item.isExcluded ? 'opacity-50' : ''}`}>
                                            ...
                                            <div className="relative">
                                                ...
                                                {linkMenuOpen?.stageId === stage.id && linkMenuOpen.itemIdx === idx && dropdownPos && (
                                                    <div
                                                        ref={linkMenuRef}
                                                        className="fixed bg-white dark:bg-zinc-800 border dark:border-zinc-600 shadow-xl rounded z-[9999] w-72 max-h-80 overflow-y-auto flex flex-col"
                                                        ...
                                                        <div className="p-2 border-b dark:border-zinc-700 sticky top-0 bg-white dark:bg-zinc-800 z-10">
                                                            <div className="relative">
                                                                ...
                                                                <input
                                                                    type="text"
                                                                    autoFocus
                                                                    className="w-full pl-6 p-1 text-xs border-0 rounded bg-zinc-100 dark:bg-zinc-900 focus:ring-1 focus:ring-cyan-400 outline-none"
                                                                    placeholder="Szukaj..."
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div className="text-xs text-zinc-500 dark:text-zinc-400 flex items-center gap-2">
                            ...
                            <span className="text-[10px] text-zinc-500 bg-zinc-100 dark:bg-zinc-800 px-2 py-0.5 rounded">{stages.length} etapów</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="p-4 border-t border-transparent">
                        ...
                        {stages.length > 0 && !readOnly && (
                            <div className="mt-2 flex justify-center">
                                <button
                                    onClick={addStage}
                                    className="flex items-center gap-2 bg-white border border-zinc-200 text-zinc-700 hover:bg-zinc-50 hover:border-zinc-300 dark:bg-zinc-900 dark:border-zinc-700 dark:text-zinc-300 px-4 py-2 text-xs font-bold transition-all rounded"
                                >
                        ...
                        <div className="mt-6 pt-4 border-t-2 border-zinc-200 dark:border-zinc-700">
                            <div className="bg-zinc-50 dark:bg-zinc-900/50 p-3 border border-zinc-200 dark:border-zinc-700 rounded-xl mb-4">
