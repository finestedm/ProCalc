            ...
            <div className={`grid transition-[grid-template-rows] duration-500 ease-in-out ${isOpen ? 'grid-rows-[1fr]' : 'grid-rows-[0fr]'}`}>
                <div className="overflow-hidden">
                    <div className="border-t border-transparent p-4 pt-0">
                        ...
                        <div className="flex justify-end gap-2 mb-2 pt-2">
                            {!isSheetVisible && (
                                <>
                                    ...
                                    <button onClick={addCost} className="text-[10px] font-bold text-zinc-700 dark:text-zinc-300 hover:text-black bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 px-3 py-1.5 rounded flex items-center gap-1 transition-colors">
                        ...
                        {/* IBL CALCULATOR */}
                        <div className="bg-zinc-50 dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-700 p-4 rounded-xl mb-4">
                            ...
                            <div className="flex flex-wrap items-end gap-4">
                                <div className="flex flex-col">
                                    ...
                                    <div className={`h-8 px-3 flex items-center bg-zinc-200 dark:bg-zinc-800 rounded font-mono text-xs font-bold ${totalPalletSpots === 0 ? 'text-red-500 border border-red-300' : 'text-zinc-700 dark:text-zinc-300'}`}>
                                        {totalPalletSpots}
                                    </div>
                                </div>
