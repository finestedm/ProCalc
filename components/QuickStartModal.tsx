...
export const QuickStartModal: React.FC<Props> = ({ 
    ...
    useEffect(() => {
        if (isOpen) {
            setData(prev => ({
                ...prev,
                salesPerson: prev.salesPerson || defaultSalesPerson,
                assistantPerson: prev.assistantPerson || defaultSupportPerson
            }));
        }
    }, [isOpen, defaultSalesPerson, defaultSupportPerson]);
