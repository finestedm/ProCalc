            ...
            >
                ...
                <div className="grid grid-cols-2 border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 shrink-0">
                    ...
                    <div className="p-4 border-r border-zinc-200 dark:border-zinc-800">
                        <select
                            className="w-full p-2 border border-zinc-200 dark:border-zinc-700 rounded font-bold text-zinc-800 dark:text-zinc-100 bg-white dark:bg-zinc-950 focus:ring-1 focus:ring-amber-500 outline-none transition-colors mb-2"
                            value={leftId}
