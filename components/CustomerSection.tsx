...
const AddressForm: React.FC<{
    ...
    const standardInputClass = "w-full px-3 py-2 bg-transparent border border-zinc-300 dark:border-zinc-700 rounded text-xs text-zinc-900 dark:text-white placeholder-zinc-400 focus:border-amber-500 focus:ring-0 outline-none transition-all disabled:opacity-50";

    return (
        <div className={`p-4 border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 rounded-xl ${readOnly ? 'opacity-70 pointer-events-none' : ''} h-full flex flex-col`}>
            ...
            <div className="space-y-2 flex-1">
                ...
                <div className="relative group">
                    ...
                    <input
                        type="text"
                        placeholder="NIP"
                        className={`w-full pl-9 px-3 py-2 bg-transparent border rounded text-xs outline-none transition-all disabled:opacity-50 font-mono ${nipError
...
export const CustomerSection: React.FC<Props> = ({ data, onChange, readOnly, isOpen = true, onToggle }) => {
    ...
    return (
        <div className="bg-white dark:bg-zinc-950 rounded-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden mb-6 h-full flex flex-col">
            <div
