...
export const SuppliersSection: React.FC<Props> = ({
    ...
    return (
        <div className="bg-white dark:bg-zinc-950 rounded-xl border border-zinc-200 dark:border-zinc-800 mb-6 overflow-hidden transition-colors relative">
            {isImporting && (
                        ...
                        >
                            ...
                            {isNameplateTab && (
                                <div className="bg-zinc-50 dark:bg-zinc-900 p-6 animate-fadeIn flex flex-col items-center text-center border-t border-zinc-200 dark:border-zinc-700">
                                    ...
                                    <div className="bg-white dark:bg-zinc-950 p-4 shadow-sm border border-zinc-200 dark:border-zinc-700 flex flex-col md:flex-row items-center gap-6 rounded-xl">
