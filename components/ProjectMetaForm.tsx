                    ...
                    <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-4 flex-1">
                        ...
                        <div>
                            ...
                            <div className="relative flex items-center group">
                                <span className="absolute left-1 top-1 bottom-1 flex items-center justify-center text-zinc-400 text-[10px] font-mono select-none bg-zinc-100 dark:bg-zinc-800 px-1.5 rounded border border-zinc-200 dark:border-zinc-700">{sapPrefix}</span>
                                <input
                                    type="text"
                                    value={displaySap}
